YAHOO.namespace( 'YAHOO.Hack' ).FixIESelectWidth = new function()
{
	...
	function onMouseOver(e )
	{
		...
		if(el.hideEl) {
			el.hideEl.className='hideEl_hide';
		}
	...
	function onMouseOut(e , el )
	{
		...
		var doItLater = function()
		{
			...
			if(el.hideEl)
				el.hideEl.className='hideEl_show';
	...
	function constructor(sId, hideID)
	{
		sId = [ sId , ''].join('');
		...
		{			
			...
			if(hideID) {
				document.getElementById(sId).hideEl = document.getElementById(hideID);
			}
