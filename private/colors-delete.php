...
if (array_key_exists('delete', $_POST)) {
  if (!is_numeric($_POST['color_id'])) {
    die('Invalid request');
	}
  $sql = "DELETE FROM sb_colors
          WHERE color_id = {$_POST['color_id']}";
...
if ($deleted || array_key_exists('cancel_delete', $_POST) || !isset($_GET['color_id']))  {
