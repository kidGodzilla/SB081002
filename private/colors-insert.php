...
if (array_key_exists('insert', $_POST)) {
  ...
  $expected = array('color_name','color_file');
  ...
  $sql = "INSERT INTO sb_colors (color_name, color_file)
          VALUES('$color_name','$color_file')";
  // process the query
...
<!-- BEGIN INSERT FORM -->
<h1>New Color Entry</h1>

<form id="theform" name="theform" method="post" enctype="multipart/form-data" action="" >
	<p><b>STEP 01) Upload Image</b></p>
    <p><label for="color_file">Color Swatch:</label><br /><input type="hidden" name="MAX_FILE_SIZE" value="<?php echo MAX_FILE_SIZE; ?>" /><input type="file" name="image" id="image" /></p>
    <?php
	// if the "upload image" button has been submitted, display result
	if (isset($result)) {
	  echo "<p><strong>$result</strong></p>";
	  echo "<p><input type=\"hidden\" name=\"color_file\" value=\"$poo\" /></p>";
	  echo "<p><img src=\"../colors/$poo\" /></p>";
	  }
	?>
    <p><input type="submit" name="upload" id="upload" value="Upload" /></p>
    <p><b>STEP 02) Insert Data</b></p>
    <p><label for="color_name">Color Name:</label><br /><input id="color_name" name="color_name" type="text" size="25" /></p>
