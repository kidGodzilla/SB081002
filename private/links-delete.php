...
if ($deleted || array_key_exists('cancel_delete', $_POST) || !isset($_GET['link_id']))  {
...
<form id="form1" name="form1" method="post" action="">
	...
	<?php if (!empty($row)) { ?>
		<input name="link_id" type="hidden" value="<?php echo $row['link_id']; ?>" />
	<?php } ?>
    </p>
</form>
<!-- END DELETE FORM -->
