...
if (array_key_exists('insert', $_POST)) {
  ...
  $sql = "INSERT INTO sb_stores (store_name, store_file)
          VALUES('$store_name','$store_file')";
  // process the query
...
<form id="theform" name="theform" method="post" enctype="multipart/form-data" action="" >
    ...
    <p><label for="store_file">Store Image:</label><br /><input type="hidden" name="MAX_FILE_SIZE" value="<?php echo MAX_FILE_SIZE; ?>" /><input type="file" name="image" id="image" /></p>
    <?php
	// if the "upload image" button has been submitted, display result
	if (isset($result)) {
	  echo "<p><strong>$result</strong></p>";
	  echo "<p><input type=\"hidden\" name=\"store_file\" value=\"$poo\" /></p>";
	  echo "<p><img src=\"../stores/$poo\" /></p>";
	  }
	?>
    <p><input type="submit" name="upload" id="upload" value="Upload" /></p>
    <p><b>STEP 02) Insert Data</b></p>
    <p><label for="store_name">Store Name:</label><br /><input id="store_name" name="store_name" type="text" size="25" /></p>
